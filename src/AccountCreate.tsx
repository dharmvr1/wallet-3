...
import { generateAccount } from "../wallet-utils/AccountUtils.ts";
interface Account {
  privatekey: string;
  address: string;
  balance: string;
...
export function AccountCreate() {
  ...
  function handleSeedPhraseSubmit(e: React.FormEvent) {
    e.preventDefault();
  ...
  function handleSeedPhraseChange(e: React.ChangeEvent<HTMLInputElement>) {
    setSeedPhrase(e.target.value);
  }

  return (
    <div className="max-w-md mx-auto bg-white rouded-md shadow-md p-6">
      <h2 className="text-2xl font-blod mb-4 ">
        Pixel Web3 Wallet on Polygon Mumbai
      </h2>
      <button
